...
class Questions(StrEnum):
    ...
    EyeDellusion = 'В течение часа до начала головной боли отмечал(а) ли ты зрительные нарушения? (вспышки света, линии-зигзаги, слепые пятна и др.)',
    WhereHurts = 'Где отмечалась головная боль?',
    Nature = 'Характер головной боли',
    PhysicalTrigger = 'Ухудшалась ли головная боль при физической активности? (подъём по лестнице и др.)',
    ...
    Painkillers = 'Принимал(а) ли ты сегодня препараты от головной боли? Для каждого препарата укажи название, принятую дозу и время приёма',
